===================================================================
August 31st 2020 - v1.1.0
-------------------------------------------------------------------

* MAJOR FIX: Demo importer updated to fix issue created by newer versions of Elementor

===================================================================
August 31st 2020 - v1.0.15
-------------------------------------------------------------------

* FIXED: Footer widget zone ID
* ADDED: 2nd button added to header
* ADDED: Added option for hover menu rather than click
* ADDED: Menu menu titles can now be clicked if a link is set
* ADDED: Mega menu column can be set to full width
* ADDED: Mega menu column title can have image set to appear at top of column
* UPDATED: Merlin theme wizard
* ADDED: Theme option to show sidebar on single blog post

===================================================================
May 22nd 2020 - v1.0.14
-------------------------------------------------------------------

* IMPROVED: CF7 Acceptance Styling
* ADDED: Window resize trigger on load
* FIXED: Image stretching when using an image instead of icon in Elementor
* UPDATED: .POT Translation File
* FIXED: Mega menu padding on mobile
* REMOVED: /admin/menu-fields/ - not needed as of WP 5.4
* FIXED: Issue with white page showing after using back button
* FIXED: Issue with fonts having .var in filename
* FIXED: /wp-login.php form mobile styling
* ADDED: Client URL input for client post type feeds
* ADDED: Category selector to Team block and Testimonial block ( update TR Framework )
* FIXED: Accordions with numbers at beginning of title ( update TR Framework )
* FIXED: Home course form radio buttons appearance
* FIXED: WPML translation issue with select Elementor elements
